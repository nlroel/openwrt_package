...
o = s:taboption("developer", Flag, "disable_obscure", translate("Disable Obscure"), translate("Completely disable obscure, turn the program into a normal udp tunnel"))
o = s:taboption("developer", Flag, "disable_mss", translate("Disable Mss"), translate("Completely disable mss, turn the program into a normal udp tunnel"))
o = s:taboption("developer", Flag, "disable_checksum", translate("Disable Checksum"), translate("Completely disable checksum, turn the program into a normal udp tunnel"))
